    ...
    >
      ...
      {[
        ...
        <div key={i} aria-hidden style={{
          ...
          top: m.top, left: (m as any).left, right: (m as any).right, bottom: (m as any).bottom,
      ...
      <div aria-hidden className="glass-soft" style={{
        ...
        <div className="mono" style={{
          ...
          {Array.from({ length: 2 }).map((_, k) => (
            <span key={k} style={{ display: 'flex', gap: 36 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="mono" style={{
            ...
            {BOOT_LINES.slice(0, shown).map(([time, msg], i) => (
              <div key={i} style={{ animation: 'boot-in .25s ease-out both', display: 'flex', gap: 14 }}>
                <span style={{ color: 'var(--accent-deep)', width: 36 }}>{time}</span>
